    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-4 offset-2">
                ...
                <input type="text" class="form-control" id="inputPassword4" placeholder="Project's name" name="nome" value="<?php echo $result[0]->getNomeT(); ?>"disabled>
                <br>
                <label for="exampleFormControlTextarea1" align="center">Description</label>
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" align="center" name="descrizione" disabled><?php echo $result[0]->getDescrizioneT();?></textarea>
                <br>
